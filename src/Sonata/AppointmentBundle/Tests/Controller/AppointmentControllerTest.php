...
namespace Sonata\AppointmentBundle\Tests\Controller;
...
class AppointmentControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'sonata_appointmentbundle_appointmenttype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'sonata_appointmentbundle_appointmenttype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
